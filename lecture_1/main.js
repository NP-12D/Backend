...
/*
  ...
  arrays და functions ასევე ობიექტებია ანუ, ისინი არ არიან ცალკე მონაცემთა ტიპები, არამედ object‑ის ქვეკატეგორიები არიან.
  აქედან 7 არის პრიმიტიული, ობიექტი კი არის  არაპრიმიტიული. პრიმიტიული ნიშნავს რომ immutable ანუ არ არის შეცვლადი, ხოლო არაპრიმიტიული mutable ანუ არის შეცვლადი.
*/
/*
...
/*
   5)ჩამოთვალე რა მეთოდები ვისწავლეთ მაგ -> length(პასუხი თეორიულად გაეცი)
    ...
    slice - slice(start,end) მეთოდი გვიბრუნებს პირველი არგუმენტიდან მეორე არგუმენტამდე მნიშვნელობებს
